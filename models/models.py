...
class Model(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        '''
        x1 = torch.stack((flair_x1, t1ce_x1, flair_x1, t1ce_x1), dim=1) #Bx4xCxHWZ
        x2 = torch.stack((flair_x2, t1ce_x2, flair_x2, t1ce_x2), dim=1)
        x3 = torch.stack((flair_x3, t1ce_x3, flair_x3, t1ce_x3), dim=1)
        x4 = torch.stack((flair_x4, t1ce_x4, flair_x4, t1ce_x4), dim=1)
        '''
        x1 = torch.stack((flair_x1, t1ce_x1), dim=1) #Bx4xCxHWZ
        x2 = torch.stack((flair_x2, t1ce_x2), dim=1)
        x3 = torch.stack((flair_x3, t1ce_x3), dim=1)
        x4 = torch.stack((flair_x4, t1ce_x4), dim=1)
        ...
        if self.is_training:
            ...
            return fuse_pred, (flair_pred, t1ce_pred), prm_preds
        return fuse_pred

...
class prm_generator_laststage(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        # print(x.shape, mask.shape, mask, mask.dtype)
        y[mask, ...] = x[mask, ...]
...
class region_aware_modal_fusion(nn.Module):
    def __init__(self, in_channel=64, norm='in', num_cls=4):
        ...
        self.clsname_list = ['BG', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET'] ##BRATS2020 and BRATS2018
        self.clsname_list = ['BG', 'NCR', 'ED', 'NET', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET', 'NCR/NET', 'ED', 'ET'] ##BRATS2015
    ...
    def forward(self, x, prm, mask):
        ...
        prm = torch.unsqueeze(prm, 2).repeat(1, 1, C, 1, 1, 1)  # 类别的特征图扩充一个通道维度，并重复C=128次

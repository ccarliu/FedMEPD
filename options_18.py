...
def args_parser():
    ...
    parser.add_argument('--save_root', default='/jizhicfs/datalh/fedMEMA', type=str)
    ...
    # FL Settings
    parser.add_argument('--gpus', default='0,1,2,3,4', help="To use cuda, set to a specific GPU ID. Default set to use CPU.")
